    ...
    <div class="sidebar-wrapper sidebar-theme">
        <nav ref="menu" id="sidebar">
            ...
            <perfect-scrollbar class="list-unstyled menu-categories" tag="ul" :options="{ wheelSpeed: 0.5, swipeEasing: !0, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: true }">
                ...
                <div v-if="userRoles === 'Admin'">
                    <li class="menu">
                        <a class="dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#request" aria-controls="request" aria-expanded="false">
                            <div class="">
                                <svg
                        ...
                        <ul id="request" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                            <li>
                                <router-link to="/request/letter" @click="toggleMobileMenu">Letter</router-link>
                            </li>
